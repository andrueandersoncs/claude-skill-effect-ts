...
export const TrackingNumber = Schema.String.pipe(Schema.brand("TrackingNumber"))
...
export class HttpClient extends Context.Tag("HttpClient")<
  HttpClient,
  {
    ...
    readonly post: <A>(url: string, body: unknown) => Effect.Effect<A, NetworkError>
  }
>() {}
...
export const OrderRepositoryLive: Layer.Layer<OrderRepository, never, Database> =
...
export const OrderServiceLive: Layer.Layer<OrderService, never, OrderRepository> =
...
export declare const saveOrder: (
  order: Order
) => Promise<Order>
...
export declare const fetchData: () => Effect.Effect<{ items: ReadonlyArray<Item> }>
export declare const fetchFromPrimary: () => Effect.Effect<unknown, NetworkError>
export declare const fetchFromBackup: () => Effect.Effect<unknown, NetworkError>
...
export declare const processOrderEvent: (orderId: OrderId) => Effect.Effect<void>
...
export declare const validate: <A>(value: A) => Effect.Effect<A, ValidationError>
...
export declare const compatibleFunction: (input: unknown) => Effect.Effect<unknown>
